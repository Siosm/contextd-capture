...
//Deprecated! Please use context_changed
extern "C" context_result domain_changed(const char* param_name, ...)
{
	const char* name;
	const char* value;
...
// Deprecated! See context_changed_async
extern "C" unsigned int domain_changed_async(contextChangedCallbackSuccess success_cb,
...
extern "C" context_bool context_required_domain(char* required_context, size_t maxlen, const char* param_name, ...)
{
	const char* name;
	const char* value;
	...
	QString req_context;
	bool res=ccom()->requiredDomain(xmlContext, req_context);
...
extern "C" context_bool context_current_domain(char* state_buf, unsigned int max_size)
{
	QString res=ccom()->currentDomain();
