...
void KernelContext::clearProgList(QStringList& l)
{
	l.removeAll(".");
	l.removeAll("..");
	l.removeAll("context-notify.xml");
	l.removeAll("firefox.xml");
	l.removeAll("claws-mail.xml");
}
