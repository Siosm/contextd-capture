...
cd $root/mozilla-1.9.1/extensions/pigacontext
svn update

cd $root/mozilla-1.9.1/obj-i686-pc-linux-gnu
...
cp -r $root/mozilla-1.9.1/obj-i686-pc-linux-gnu/extensions/pigacontext/src/libPIGAContext.so $root/PIGAContext\@sds-project.fr/components
cp -r $root/mozilla-1.9.1/obj-i686-pc-linux-gnu/extensions/pigacontext/public/_xpidlgen/PIGAContext.xpt $root/PIGAContext\@sds-project.fr/components
