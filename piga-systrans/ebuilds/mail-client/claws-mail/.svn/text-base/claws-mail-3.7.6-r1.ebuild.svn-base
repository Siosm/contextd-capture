...
src_unpack() {
	...
	cd "${S}"
	epatch "${FILESDIR}/add_compose_destroy_all.patch"
	epatch "${FILESDIR}/mail_pre_open_hook.patch"
	epatch "${FILESDIR}/on_compose_reply_mail_hooklist.patch"
	epatch "${FILESDIR}/mail_pre_list_hooklist.patch"
	epatch "${FILESDIR}/session_hooklist.patch"
	epatch "${FILESDIR}/source_window_destroy_all.patch"
	#epatch "${FILESDIR}/claws-mail-chroot-into-download.patch"
	epatch "${FILESDIR}/on_reply_list_patch.patch"
	#epatch "${FILESDIR}/imap_auth.patch"
	epatch "${FILESDIR}/imap_session_hooklist.patch"
	epatch "${FILESDIR}/restrict_filesel.patch"
	epatch "${FILESDIR}/on_attach_files.patch"
	epatch "${FILESDIR}/on_send_message_check_mail_hooklist.patch"
	epatch "${FILESDIR}/on_insert_files.patch"
	epatch "${FILESDIR}/claws-mail-deny-load-unload-plugins.diff"
	#epatch "${FILESDIR}/on_reply_mail_hooklist.patch"
