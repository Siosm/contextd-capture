...
\subsubsection{Application de règles de politiques par les types (Type Enforcement)}

Ce principe repose sur l'association d'un context de sécurité à chaque objets et processus. L'accès à un object par un processus doit correspondre à une règle de la politique de sécurité pour être autorisé.
