...
\begin{itemize}
  ...
  \item Ne faire confiance à aucun programme, mais s'assurer qu'une politique de sécurité est appliqué par des méchanismes matériels de confiance% trustworthy hardware mechanisms. %FIXME
\end{itemize}
...
\begin{figure}[h]
	\centering
	\includesvg{attachements/bell-lp}{0.5}
...
\begin{figure}[h]
	\centering
	\includesvg{attachements/biba}{0.5}
...
\textsc{grsecurity} est une autre implémentation des mécanismes de contrôle d'accès mandataire et des listes de contrôle d'accès. % et basé sur les rôles.
