...
\lstset{language=make,captionpos=b,tabsize=3,frame=single,keywordstyle=\color{blue},commentstyle=\color{darkgreen},stringstyle=\color{red},numbers=left,numbersep=5pt,breaklines=true,showstringspaces=false,basicstyle=\footnotesize,emph={label}}
\lstset{language=C,captionpos=b,tabsize=3,frame=single,keywordstyle=\color{blue},commentstyle=\color{darkgreen},stringstyle=\color{red},numbers=left,numbersep=5pt,breaklines=true,showstringspaces=false,basicstyle=\footnotesize,emph={label}}
...
\subsection{Création des éléments nécessaire au module}
...
Maintenant, voyons les modifications apportées à contextd. 
