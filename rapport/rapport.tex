...
\begin{figure}[hb]
	...
	\caption{Communication entre les hooks LSM et les appels système avant les modifications}
\end{figure}

\begin{figure}[hb]
	\centering
	\includesvg{attachements/fonctionnement_apres}{1}
	\caption{Communication entre les hooks LSM et les appels système maintenant}
\end{figure}

\begin{figure}[hb]
	\centering
	\includesvg{attachements/schema_general}{1}
	\caption{Schema général}
\end{figure}
